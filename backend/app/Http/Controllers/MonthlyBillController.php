            ...
            try {
                ...
                return [
                    ...
                    'customer' => $customer ? [
                        ...
                        'meter_photo_url'      => $customer->meter_photo_url ? \Illuminate\Support\Facades\Storage::url($customer->meter_photo_url) : null,
                        'user' => $user ? [
                            'id'    => $user->id,
                            'name'  => $user->name,
                            'email' => $user->email,
    ...
    public function usage(Request $request)
    {
        ...
        $items = $customers->map(function ($customer) use ($month, $year) {
            ...
            return [
                ...
                'reading_photo'        => $reading?->photo_url ? \Illuminate\Support\Facades\Storage::url($reading->photo_url) : null,
