<template>
  <div class="teknisi-retribusi-root p-2! lg:p-4!">
    ...
    >
      ...
      >
        <div class="relative!">
          ...
          <div
            class="absolute! -bottom-0.5! -right-0.5! w-2.5! lg:w-3.5! h-2.5! lg:h-3.5! bg-emerald-500! border-2! border-white! rounded-full!"
          ></div>
        </div>
        <div>
          <div
            class="text-[10px]! lg:text-[10px]! font-black! text-cyan-600! uppercase! tracking-widest! opacity-80!"
          >
            Petugas
          </div>
          <div class="text-xs! lg:text-sm! font-black! text-slate-800! leading-tight!">
            Ahmad Subarjo
          </div>
        </div>
      </div>
    ...
    <ContentCard
      ...
      padding="normal"
      rounded="2xl"
      class="shadow-[0_20px_25px_-5px_rgba(15,23,42,0.12),0_10px_10px_-5px_rgba(15,23,42,0.04)]! mb-12!"
    >
      <div class="space-y-8! pb-4!">
        ...
        <div class="relative! group!">
          <div
            class="absolute! inset-0! bg-cyan-500/10! rounded-[2rem]! blur-2xl! opacity-0! group-focus-within:opacity-100! transition-all! duration-500!"
          ></div>
          <div
    ...
    <div class="space-y-4!">
      ...
      >
        ...
        >
          <font-awesome-icon
            :icon="item.status === STATUS_TYPES.PAID ? 'check-double' : 'trash'"
            size="lg"
          />
        </div>

        <div class="flex-1! min-w-0!">
          <h3 class="font-black! text-slate-800! text-base! lg:text-base! truncate!">
            {{ item.nama }}
          </h3>
          <p class="text-xs! lg:text-xs! font-bold! text-slate-400! tracking-wider!">
            ID: {{ item.id }} • RT 02/01
          </p>
          <div
            class="flex! items-center! gap-1! text-[11px]! lg:text-[10px]! font-black! text-cyan-600! uppercase! tracking-tighter!"
          >
      ...
      <div
        v-if="totalPages > 1"
        class="hidden! lg:flex! items-center! justify-center! gap-2! mt-10! pb-10!"
      >
        <button
          @click="currentPage--"
