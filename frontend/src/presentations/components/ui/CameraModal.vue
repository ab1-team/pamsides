    ...
    <div v-if="show" class="modal-overlay" @click="closeModal">
      <div class="modal-container max-w-xl!" @click.stop>
        ...
        <div class="modal-body p-6!">
          <div
            class="relative! aspect-[4/3]! bg-black! rounded-2xl! overflow-hidden! shadow-inner!"
          >
            <video
              ref="videoRef"
              autoplay
            ...
            <div class="absolute! inset-8! border-2! border-white/20! pointer-events-none!">
              <div
                class="absolute! -top-1! -left-1! w-6! h-6! border-t-4! border-l-4! border-orange-500!"
              ></div>
              <div
                class="absolute! -top-1! -right-1! w-6! h-6! border-t-4! border-r-4! border-orange-500!"
              ></div>
              <div
                class="absolute! -bottom-1! -left-1! w-6! h-6! border-b-4! border-l-4! border-orange-500!"
              ></div>
              <div
                class="absolute! -bottom-1! -right-1! w-6! h-6! border-b-4! border-r-4! border-orange-500!"
              ></div>
            </div>
