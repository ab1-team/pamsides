    ...
    <BaseReportLayout :lembaga="payload?.lembaga" :config="payload?.config">
        <div ref="rootEl" class="calk-root">
            ...
            <div class="page-content">
                <!--
                  Struktur section CaLK:
                    A. Gambaran Umum               (hanya isFirstPage)
                    B. Ikhtisar Kebijakan          (hanya isFirstPage)
                    C. Informasi Tambahan          (semua halaman)
                    D. Pembagian Laba Usaha        (hanya isLastPage)
                    E. Penutup                     (hanya isLastPage)

                  Strategi render:
                    - Page 1 (isFirstPage): pakai <ol> dengan semua section.
                      Section informasi punya heading "Informasi Tambahan".
                    - Page 2+ (non-first, non-last): section informasi render sebagai
                      <div> flat (tanpa <li>/numbering) karena dia lanjutan tabel,
                      bukan section baru.
                    - Last page (isLastPage): section informasi + pembagian + penutup.
                      Pembagian & penutup tetap dengan label D, E (lanjut dari C).

                  Untuk halaman bukan-first, kita render section informasi sebagai
                  plain <div>, dan section pembagian/penutup sebagai <ol start="4">
                  (sehingga D, E).
                -->
                ...
                <ol v-if="isFirstPage" style="list-style: upper-alpha; font-size: 12px;">
                    ...
                    <li data-block="sec-informasi" style="margin-top: 12px; break-inside: avoid;">
                        ...
                        <calk-table :rows="rows" :show-table-header="showTableHeader" :is-last-page="isLastPage" :total-saldo="payload?.total_saldo" :format-currency="formatCurrency" />
                    </li>
