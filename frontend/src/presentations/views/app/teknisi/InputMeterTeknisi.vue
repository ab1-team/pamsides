      ...
      <div class="flex! items-center! gap-3! md:gap-4!">
        ...
        <div>
          ...
          <p class="text-xs! md:text-sm! text-slate-500!">
            Silakan input meter akhir pelanggan and upload foto meteran
          </p>
        </div>
      </div>
    </div>
      ...
      <div class="p-6! border-b! border-slate-50!">
        <div class="flex! items-center! justify-between! gap-3! mb-5!">
          <div class="flex! items-center! gap-3!">
            ...
            />
            <div>
              <h1 class="text-lg! font-black! text-slate-800! leading-tight!">Input Pencatatan</h1>
              <p class="text-[10px]! uppercase! tracking-[0.2em]! text-slate-400!">Teknisi</p>
            </div>
          </div>
        </div>
...
import InputMeterModal from '@/presentations/views/app/admin/tagihan/partials/inputMeterModal.vue'
...
const handleBack = () => {
  router.push('/app/instalasi/teknisiPemakaianAir')
}
