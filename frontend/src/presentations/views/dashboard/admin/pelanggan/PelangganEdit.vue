        ...
        <ContentCard variant="elevated" padding="none" hoverable
            ...
            <div class="p-6! sm:p-10!">
              ...
              { id: 'Perempuan', text: 'Perempuan' },
                    ...
                    <BaseInput v-model="form.password" type="password" label="Password Baru"
                        placeholder="Kosongkan jika tidak diubah" icon="lock" />
                </div>
    ...
    onMounted(async () => {
        ...
        try {
            ...
            form.value = {
                ...
                jenis_kelamin: data.gender == 'female' ?
                    'Perempuan' :
                    'Laki-laki',
