<template>
    <div class="pelanggan-root relative">
        ...
        <DataTable :data="filteredData" :columns="tableColumns" title="" v-model:current-page="currentPage"
            v-model:per-page="perPage" :total-pages="totalPages" :visible-pages="visiblePages"
            :total-entries="tableData.length" v-model="searchQuery" class="mt-6!" search-placeholder="Cari pelanggan..."
            ...
            <template #search-actions>
                <BaseButton variant="ghost" size="sm" @click="fetchCustomers" :loading="isLoading"
                    ...
                    title="Muat Ulang Data" icon="sync-alt" />
            </template>
            ...
            <template #column-aksi="{ row }">
                <div class="flex items-center gap-2!">
                    <BaseButton variant="ghost" size="sm" @click="handleEdit(row)"
                    ...
                    <BaseButton variant="ghost" size="sm" @click="handleDelete(row)"
