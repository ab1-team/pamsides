<template>
  <div class="admin-retribusi-root p-2! lg:p-4!">
    <!-- Header Section -->
    <div
      class="mb-6! lg:mb-8! flex! flex-col! lg:flex-row! lg:items-center! justify-between! gap-4! lg:gap-6!"
    >
      <div>
    ...
    <div class="mb-6!">
      <ContentCard
        ...
        padding="normal"
        rounded="2xl"
        class="rounded-3xl! shadow-2xl! border-none! bg-linear-to-br! from-white! to-slate-50/50!"
      >
        <div class="grid! grid-cols-1! lg:grid-cols-12! gap-4! items-center!">
          <div class="lg:col-span-9! grid! grid-cols-1! sm:grid-cols-12! gap-3! items-center!">
            ...
            <div
              class="sm:col-span-12! lg:col-span-2! flex! items-center! justify-center! lg:justify-start!"
            >
              <BaseButton
                ...
                icon="sliders"
              >
                <span class="lg:hidden! ml-2! font-black! uppercase! text-[11px]!"
                  >Terapkan Filter</span
                >
              </BaseButton>
            </div>
          </div>
    ...
    <div class="space-y-4!">
      ...
      >
        <div class="flex! items-center! gap-4! w-full! lg:w-auto! lg:flex-1!">
          ...
          <div class="min-w-0!">
            <div class="flex! items-center! gap-2! mb-1!">
              <h3
                class="font-black! text-slate-800! text-base! lg:text-lg! truncate! leading-tight!"
              >
                {{ item.nama }}
              </h3>
              <span
                class="px-2! py-0.5! bg-blue-50! text-blue-500! border! border-blue-100! rounded-lg! text-[9px]! font-black! uppercase! tracking-wider! shrink-0!"
              >
                {{ item.jenis || 'Reguler' }}
              </span>
            </div>
            <div class="flex! flex-wrap! items-center! gap-x-3! gap-y-1!">
              <span
                class="px-2! py-0.5! bg-slate-100! text-slate-500! rounded-md! text-[10px]! font-black! tracking-wider!"
                >ID: {{ item.id }}</span
              >
        ...
        <div
          class="flex! flex-row! items-center! justify-between! sm:justify-start! gap-6! lg:gap-16! py-3! lg:py-0! border-y! border-slate-50! lg:border-y-0! lg:border-l! lg:border-slate-100! lg:pl-12! w-full! lg:w-auto!"
        >
      ...
      <div
        ...
        class="py-20! text-center! bg-white! rounded-3xl! border! border-dashed! border-slate-200!"
      >
        <div
        ...
        <p class="text-sm! text-slate-500! max-w-xs! mx-auto!">
          Tidak ada data retribusi yang sesuai dengan filter atau pencarian Anda.
        </p>
      </div>
