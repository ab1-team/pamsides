    ...
    >
      ...
      >
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2">
          <div class="flex-1">
            <div class="font-semibold text-gray-900 text-sm sm:text-base">{{ customer.name }}</div>
            <div class="text-xs sm:text-sm text-gray-600">
              {{ customer.id }} • {{ customer.installationCode }}
            </div>
          </div>
          <div class="text-xs bg-green-100 text-green-800 px-2 py-1 rounded-full w-fit sm:w-auto">
            {{ customer.status }}
          </div>
        </div>
      </div>
                ...
                <div class="flex items-center justify-between">
                  <div class="flex items-center gap-2 sm:gap-4">
                    <div class="relative group">
                      ...
                      >
                        <img :src="getQRCodeUrl()" alt="QR Code" class="w-full h-full rounded-md" />
                    ...
                    <div class="flex-1 min-w-0">
                      ...
                      <div class="text-xs sm:text-sm font-mono font-bold text-white truncate">
                        {{ billingStore.selectedCustomer?.id || 'PAM-2025-09821' }}
                      </div>
...
import CustomSearch from '../../../../components/ui/CustomSearch.vue'
